...
def one_hot_encoded(class_numbers, num_classes=None):
    ...
    Args:
        ...
        num_classes: Number of classes. If None then use max(class_numbers)+1.
    Return:
...
class DataSet:
    def __init__(self, in_dir, exts='.jpg'):
        ...
        Args:
            in_dir: Root-dir for the files in the data-set.
                    This would be 'knifey-spoony/' in the example above.
            exts: String or tuple of strings with valid filename-extensions.
                  Not case-sensitive.
        Return:
            Object instance.
        """
    ...
    def _get_filenames(self, dir):
        ...
        Args:
            dir: Directory to scan for files. Sub-dirs are not scanned.
        Return:
    ...
    def get_paths(self, test=False):
        ...
        Args:
            test: Boolean. Return the paths for the test-set (True) or training-set (False).
        Return:
    ...
    def copy_files(self, train_dir, test_dir):
        ...
        Args:
            train_dir: Directory for the training-set e.g. 'knifey-spoony/train/'
            test_dir: Directory for the test-set e.g. 'knifey-spoony/test/'
        Return: Nothing.
        """
